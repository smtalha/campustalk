...
namespace CampusTalk.Encryption
{
    class StringCipher
    {
        ...
        public static string Encrypt(string toEncrypt, string key = "NoiPTircNEkLtAeYkSUpmAc")
        {
            try
            {
        ...
        public static string Decrypt(string cipherString, string key = "NoiPTircNEkLtAeYkSUpmAc")
        {
            try
            {
                // Get the MD5 key hash (you can as well use the binary of the key string)
